...
Mainly a **frontend developer** (JavaScript, React, Sass), with backend
experience too (**C# APIs, onion architecture**).

Before this, I was at **One Model**, building with **React, TypeScript, C#**.
Along the way, I picked up studies in **data analytics and ethical AI**.
